...
{
       0,    64,    64,    67,    73,    76,    78,    80,    83,    88,
      89,    94,    96,   100,   101,   104,   108,   109,   112,   119,
...
static const char *const yytname[] =
{
  ...
  "MINUS", "TIMES", "DIVIDEDBY", "LT", "GT", "EQ", "NEQ", "GTE", "LTE",
  "SEMICOLON", "LPAREN", "RPAREN", "NEWLINE", "COLON", "INDENT", "DEDENT",
  "COMMA", "BREAK", "WHILE", "IF", "ELIF", "ELSE", "AND", "DEF", "FOR",
  "NOT", "OR", "BOOL", "RETURN", "DONE", "$accept", "program", "statement",
  "if_contents", "while_contents", "contents_inner", "expression",
  "condition", "compare", "item", YY_NULLPTR
};
#endif
...
{
       5,     3,    19,     1,     1,   -63,     2,   -63,   -63,     8,
      80,   -63,     9,    16,   -63,   -63,   -63,   -63,     8,   -63,
      45,   -63,   -63,   -63,   -63,   -63,   -63,    17,    26,    28,
      71,     8,     8,     8,     8,   -63,   -63,   -63,   -63,    27,
      29,   -63,    35,    35,   -63,   -63,     7,     6,    21,     1,
      43,    61,     1,    47,    48,     8,    51,   -63,     8,    62,
      50,   -63,    49,    64,    53,    65,    60,     7,    66,     6,
      75,    15,   -63,    15,   -63,    15,    83,    78,    63,    76,
      77,     8,   -63,   -63,   -63,     6,    67,   -63,   -63
};
...
{
       0,     0,     0,     0,     0,     8,     0,     3,     7,     0,
      27,    29,     0,     0,     1,     2,    25,    24,     0,    26,
       0,    30,    32,    34,    35,    33,    31,     0,     0,     0,
       0,     0,     0,     0,     0,     4,    36,    37,    28,     0,
       0,    19,    20,    21,    22,    23,    13,     9,     0,     0,
       0,     0,     0,     0,     0,     0,     0,     6,     0,     0,
       0,     5,     0,     0,     0,     0,     0,    13,     0,     9,
       0,    16,    14,    16,    10,    16,     0,     0,     0,     0,
       0,     0,    18,    12,    15,     9,     0,    11,    17
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -63,   -63,    94,   -62,    34,   -56,   -18,    -3,   -63,   -63
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     6,     7,    54,    50,    78,    20,    12,    27,    38
};
...
{
      30,    13,    14,     1,    10,     2,     1,    74,     2,    51,
      48,    16,    17,    42,    43,    44,    45,    79,    76,    80,
      36,    37,     8,    87,     9,    18,    55,     3,     4,    28,
       3,     4,    52,    49,    53,    11,    29,    62,     5,    77,
      64,     5,    19,    33,    34,    39,    56,    40,    46,    59,
      47,    31,    32,    33,    34,    31,    32,    33,    34,    31,
      32,    33,    34,    86,    35,    57,    58,    60,    67,    66,
      61,    63,    69,    31,    32,    33,    34,    31,    32,    33,
      34,    71,    65,    68,    70,    83,    88,    73,    81,    41,
      21,    22,    23,    24,    25,    26,    75,    82,    84,    85,
      15,    72
};

static const yytype_uint8 yycheck[] =
{
      18,     4,     0,     1,     3,     3,     1,    69,     3,     3,
       3,     3,     4,    31,    32,    33,    34,    73,     3,    75,
       3,     4,    19,    85,     5,    17,     5,    25,    26,    20,
      25,    26,    26,    26,    28,    34,    20,    55,    36,    24,
      58,    36,    34,     8,     9,    19,    49,    19,    21,    52,
      21,     6,     7,     8,     9,     6,     7,     8,     9,     6,
       7,     8,     9,    81,    19,    22,     5,    20,    19,    19,
      22,    20,    19,     6,     7,     8,     9,     6,     7,     8,
       9,    21,    20,    19,    19,    22,    19,    21,     5,    18,
      10,    11,    12,    13,    14,    15,    21,    19,    22,    22,
       6,    67
};
...
{
       0,     1,     3,    25,    26,    36,    38,    39,    19,     5,
       3,    34,    44,    44,     0,    39,     3,     4,    17,    34,
      43,    10,    11,    12,    13,    14,    15,    45,    20,    20,
      43,     6,     7,     8,     9,    19,     3,     4,    46,    19,
      19,    18,    43,    43,    43,    43,    21,    21,     3,    26,
      41,     3,    26,    28,    40,     5,    44,    22,     5,    44,
      20,    22,    43,    20,    43,    20,    19,    19,    19,    19,
      19,    21,    41,    21,    40,    21,     3,    24,    42,    42,
      42,     5,    19,    22,    22,    22,    43,    40,    19
};
...
#line 64 "parser.y" /* yacc.c:1661  */
    {
      statementStr = new std::string(*(yyvsp[0].str));
...
#line 80 "parser.y" /* yacc.c:1661  */
    {
      std::cerr << "Error: bad statement on line " << (yylsp[-1]).first_line << std::endl;
      _error = true; }
...
#line 1700 "parser.cpp" /* yacc.c:1661  */
      default: break;
    }
